...
export const useReactNativeConfig = async (apiKey, options) => {
  ...
  const deviceId = (options === null || options === void 0 ? void 0 : options.deviceId) ?? queryParams.deviceId ?? (previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.deviceId) ?? UUID();
